// 枪械数据表（参考《无畏契约》国服数值/手感）。蛋蛋 100 血。
// 所有枪模型都来自 Quaternius「Ultimate Guns Pack」(CC0/CC-BY)，同一套→朝向统一。
...
export const GUNS: GunDef[] = [
  {
    ...
    mag: 12, reserve: 36, fireCd: 0.15, bodyDmg: 26, headDmg: 78, auto: false, price: 0,
    baseSpread: 0.007, altBurst: true,
    view: { pos: [0.3, -0.34, -0.68], rotY: ROT, size: 0.5, muzzleZ: -0.62 },
  },
  {
    id: 'shorty', name: '短炮', model: 'models/weapons/shotgun.glb',
    mag: 2, reserve: 8, fireCd: 0.32, bodyDmg: 12, headDmg: 36, auto: false, price: 150,
    baseSpread: 0.012, pellets: 12, pelletSpread: 0.05,
  ...
  },
  {
    ...
    mag: 5, reserve: 15, fireCd: 0.6, bodyDmg: 101, headDmg: 202, auto: false, price: 950,
    baseSpread: 0.0015,
